...
class Correos {
    ...
    function creacionTicket($datos) {
        ...
        {
            $remitentes = array('gsolano@masmetrologia.mx', $correo);
        }
        else if ($prefijo == "ED")
        {
            $remitentes = array('gsolano@masmetrologia.mx', $correo);
...
EOD;
    ...
    function ticketSolucionado($datos) {
        ...
        {
            if ($estatus == 'ABIERTO') {
                $remitentes = array('crodriguez@masmetrologia.mx', 'jc@masmetrologia.mx', 'jcastaneda@masmetrologia.mx', $correo);
            }else{
...
EOD;
      ...
      $CI->email->from('tickets@masmetrologia.mx', 'Tool Crib');
...
function asignarQR($datos)
{
    ...
    $remitentes = array('tickets@masmetrologia.mx', $correos);
...
EOD;
      ...
      $CI->email->from('tickets@masmetrologia.mx', 'Work Oders');
...
//echo var_dump($correo_us);die();
      ...
      $mensaje = <<<EOD
             ...
             <h1><font face="Arial">SIGA-MAS</font></h1>
             <h2>Work Orders</h2>
	     <h3>El usuario: $usuario ha cerrado WO#: $mail</h3>
             Estimado cliente,
