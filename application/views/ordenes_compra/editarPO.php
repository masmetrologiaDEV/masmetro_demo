    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Editar PO-<?=str_pad($id, 6, "0", STR_PAD_LEFT)?></h2>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <button type="button" onclick='AgregarConcepto()' class="btn btn-danger btn-xs float-right"><i class="fa fa-plus"></i> Agregar Concepto</button>
                            </tbody>
                            <tbody class='sub'>
                            </tbody>
                        </table>                
                        
                        <button type="button" onclick='editarPO()' class="btn btn-success btn-md pull-right"><i class="fa fa-clock-o"></i> Guardar</button>
