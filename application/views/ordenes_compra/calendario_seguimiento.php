      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Calendario de Seguimiento (Ordenes de Compra)</h2>
                ...
                <?php if ($this->session->privilegios['adminCompras']) { ?>
                    <?php foreach ($usuario as $elem) { ?>
                    <option value=<?= $elem->usuario ?>><?= $elem->nombre?></option>
                    <?php } ?>
                <?php } ?>
                </select>
              </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="irAPo(this)" id="btnIr" type="button" class="btn btn-success"></button>
            </div>
...
<!-- JS FILE -->
<script src=<?=base_url("application/views/ordenes_compra/js/calendario_seguimiento.js"); ?>></script>
<script>
