                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select onchange="buscar()" style="display: inline; width: 12%; margin-right: 10px;" required="required" class="select2_single form-control" id="opEstatus">
                                    ...
                                    <option value="RECIBIDA PARCIAL" <?= $estatus == "RECIBIDA" ? 'selected' : '' ?>>RECIBIDA PARCIAL</option>
                                    <option value="RECIBIDA TOTAL" <?= $estatus == "RECIBIDA" ? 'selected' : '' ?>>RECIBIDA TOTAL</option>
                                    <option value="LISTA PARA CERRAR" <?= $estatus == "LISTA" ? 'selected' : '' ?>>LISTA PARA CERRAR</option>
