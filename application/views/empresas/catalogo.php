                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <form method="POST" action=<?= base_url('empresas/excel_empresas') ?> class="form-horizontal form-label-left" novalidate enctype="multipart/form-data" onkeypress="return anular(event)">
                                    ...
                                    <input id="txtBuscar" name="texto" style="display: inline;" type="text">

                                    <p style="margin-left: 10px; display: inline;">
                                        Cliente:
                                        <input type="checkbox" class="flat cbTipo" id="cbCliente" value="cliente" name="cliente" checked/>
                                        Proveedor:
                                        <input type="checkbox" class="flat cbTipo" id="cbProveedor" value="proveedor" name="proveedor" checked/>
                                    </p>
