    ...
    function guardarProveedor(){
      ...
      */
      ...
      $.ajax({
          ...
          data: { 'id_empresa' : '<?= $empresa->id ?>', 'tipo' : JSON.stringify(tipo), 'clasificacion_proveedor' : clasificacion_proveedor, 'formas_pago' : JSON.stringify(formas_pago), 'credito' : credito, 'rma_requerido' : rma_requerido, 'monto_credito' : montoCredito, 'terminos_pago' : terminosPago, 'formas_compra' : JSON.stringify(formas_compra), 'moneda_credito' : monedaCredito, 'entrega' : entrega, 'aprobado' : aprobado, 'tags' : tags, pasos_cotizacion : JSON.stringify(pasos_cotizacion), pasos_compra : JSON.stringify(pasos_compra), 'valResico' : valResico, },
          success: function(result) {
