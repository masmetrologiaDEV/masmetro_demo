                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <select onchange="reporteQR()" style="display: inline; width: 30%; margin-right: 10px;" required="required" class="selectpicker" id="opAsignado" name="opAsignado">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">                          
                            ...
                            <select onchange="reportePO()" style="display: inline; width: 30%; margin-right: 10px;" required="required" class="selectpicker" id="opRequisitor" name="opRequisitor">
                                <option value='TODO'>TODO</option>
                                <?php foreach ($asignado as $elem) { ?>
                                <option value=<?= $elem->id ?>><?= ($elem->nombre) ?></option>
                                <?php } ?>
                        ...
                        <div class="x_content">
                            <table class="table table-striped projects">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a>RECIBIDA PARCIAL</a>
                                        </td>
                                        <td class="project_progress">
                                            <a target="_blank" href="<?= base_url('ordenes_compra/catalogo_po/recibida') ?>">
                                                <div class="progress">
                                                    <div id="pbPOParcial"class="progress-bar bg-blue" role="progressbar"></div>
                                                </div>
                                                <small id="lblParcial"></small>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <a>LISTA PARA CERRAR</a>
                                        </td>
                                        <td class="project_progress">
                                            <a target="_blank" href="<?= base_url('ordenes_compra/catalogo_po/lista') ?>">
                                                <div class="progress">
                                                    <div id="pbPOLista" class="progress-bar bg-blue" role="progressbar"></div>
                                                </div>
                                                <small id="lblPOLista"></small>
                                            </a>
                                        </td>
                                    </tr>
