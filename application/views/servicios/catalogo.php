                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p style="margin-left: 10px; display: inline;">
                                    Tipo Estandar: 
                                    <input type="checkbox" class="flat cbType" id="cbEstandar" value="ESTANDAR" checked/>
                                    Especial:
                                    <input type="checkbox" class="flat cbType" id="cbEspecial" value="ESPECIAL" checked/>
                                </p>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="table-responsive">
                        <button type="button" onclick="modalAgregar()" id="btnAlta" style='display: none;' class="btn btn-primary btn-xs"><i class='fa fa-plus'></i> Agregar</button>
