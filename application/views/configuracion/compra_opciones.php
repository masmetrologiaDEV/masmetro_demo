            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            <a href=<?= base_url('configuracion/billing_address'); ?>>
                                <div class="animated flipInY col-md-12 col-sm-12 col-xs-12">
                                    <div class="tile-stats">
                                        <div class="icon"><i class="fa fa-building"></i>
                                        </div>
                                        <div class="count">Billing Address</div>
                                        <h3>Direcciones de Cuenta</h3>
                                    </div>
                                </div>
                            </a>
                          </div>
                          <div class="row">
                            <a href=<?= base_url('configuracion/pagos'); ?>>
                                <div class="animated flipInY col-md-12 col-sm-12 col-xs-12">
                                    <div class="tile-stats">
                                        <div class="icon"><i class="fa fa-credit-card"></i>
                                        </div>
                                        <div class="count">Pagos</div>
                                        <h3>Metodos y Cuentas de Pago</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
