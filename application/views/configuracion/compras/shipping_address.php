    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Direcciones de Envio (Shipping Address)</h2>
                        ...
                        <table id="tabla" class="table table-striped">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th style="width: 15%;" class="column-title">País</th>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">Dirección de Envio</h4>
            </div>
            ...
            <form>
                ...
                <label style="margin-left:15px; margin-top: 10px;">País</label>
                <div class="item form-group">
                    <div class="col-xs-4">
                        <select id="opPais" class="select2_single form-control">
...
<!-- JS FILE -->
<script src=<?= base_url("application/views/configuracion/compras/js/shipping_address.js"); ?>></script>
<script>
