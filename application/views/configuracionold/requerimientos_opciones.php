    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Configuraciones - Requerimientos</h2>
                    ...
                    <div class="x_content">
                        <div class="row">
                            <a href=<?= base_url('configuracion/evaluador_requerimiento'); ?>>
                                <div class="animated flipInY col-md-12 col-sm-12 col-xs-12">
                                    <div class="tile-stats">
                                        <div class="icon"><i class="fa fa-user"></i>
                                        </div>
                                        <div class="count">Evaluador</div>
                                        <h3>Evaluador de Requerimientos</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
