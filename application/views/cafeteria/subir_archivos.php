    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Adjuntar archivos a Comentario de Cafeteria</h2>
                    ...
                    <div class="x_content">
                        <div class="x_content">
                            <form method="POST" action=<?= base_url('cafeteria/subir_archivos') ?> class="dropzone" id="myDrop" enctype="multipart/form-data">
                        ...
                        <a class="btn btn-primary" href="<?= base_url('cafeteria/ver/' . $id_ticket) ?>">Aceptar</a>
                    </div>
                </div>
            </div>
             <h3 id="text"></h3>
