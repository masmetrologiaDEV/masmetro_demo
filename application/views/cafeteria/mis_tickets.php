    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Mis Comentarios de cafeteria</h2>
                                    ...
                                    foreach ($tickets->result() as $elem) {
                                        ...
                                        ?>
                                            <tr class="even pointer">
                                                <td><?= str_pad($elem->id, 6, "0", STR_PAD_LEFT) ?></td>
                                                <td>
                                                ...
                                                <td><?= $elem->tipo ?></td>
                                                <td><?= $elem->titulo ?></td>
                                                <td><a href=<?= base_url("cafeteria/ver/" . $elem->id) ?>><button type="button" class=<?= "'" . $BTN_CLASS . "'" ?> ><?= $elem->estatus ?></button></a></td>
                                            </tr>
                                        <?php
                                    }
                                }
