            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <select onchange="buscar()" style="display: inline; width: 12%; margin-right: 10px;" required="required" class="select2_single form-control" id="opTec" name="opTec">
                                    <option value="TODO" >TODO</option>
                                    <?php
                                        foreach ($tecnicos as $value) {
                                 
                                    ?>
                                    <option value="<?=$value->email_tecnico?>"><?=$value->Nombre?></option>
                                    <?php
                                }
                                    ?>
                             ...
                             <select onchange="buscar()" style="display: inline; width: 12%; margin-right: 10px;" required="required" class="select2_single form-control" id="opEstatus" name="opEstatus">
                                    ...
                                    <option value="3" >CONLCUIDA</option>
                ...
                <button id="btnRemoverCliente" onclick="removerCliente()" style="display: none;" class="btn btn-danger btn-xs" type="button"><i class="fa fa-close"></i></button>
                            ...
                            <p style="margin: 10px; display: inline;">
                                    Ver Cerradas:
                                    <input onclick="buscar()" type="checkbox" class="flat" id="cbCerradasCanceladas" name="cbCerradasCanceladas" value="1"/>
                                </p>
                                ...
                                <thead>
                                    <tr class="headings">
                                       ...
                                       <th class="column-title">Tecnico</th>
                                        ...
                                        <th class="column-title">Fecha Programada</th>
...
<script src=<?= base_url("application/views/ordenes_trabajo/js/catalogo_wo.js"); ?>></script>
<!-- JS FILE -->
<script>
