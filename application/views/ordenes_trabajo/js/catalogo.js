...
function buscar(){
        var URL = base_url + "ordenes_trabajo/ajax_getSolicitudes";
    ...
    $.ajax({
        type: "POST",
        url: URL,
        data: { texto : texto, estatus : estatus, cliente : cliente, tipo : tipo, cerradas : cerradas, fecha1 : fecha1, fecha2 : fecha2 },
