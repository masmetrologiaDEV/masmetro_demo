                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">                                            
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div id="btnArchivoN">
                                                    <label class="btn btn-dark btn-xs" for="userfile">
                                                    <input accept="application/pdf" target="_blank" onchange="uploadFileN();" type="file" class="sr-only" id="userfileN" name="userfileN">
                                                        <i class="fa fa-file"></i> Subir Archivo 
                                                    </label>
                                                </div>
...
<!-- JS FILE -->
<script src=<?= base_url("application/views/compras/js/clonar_qr.js"); ?>></script>
